...
export default function SideBar() {
  ...
  return (
    <aside className="flex basis-1/4 items-start justify-center gap-6 bg-[url('/images/bg-sidebar-mobile.svg')] bg-cover bg-no-repeat p-10 md:basis-1/3 md:flex-col md:justify-start md:rounded-xl md:bg-[url('/images/bg-sidebar-desktop.svg')] md:pl-7">
